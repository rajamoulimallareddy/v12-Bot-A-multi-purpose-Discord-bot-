...
module.exports = class extends Command {
	...
	timescale: { speed: 1.0 },          
			...
			const msg = await message.channel.send(`<a:loadin5g:776063953485955072> Reseting **speed**. This may take a few seconds...`);
...
timescale: { speed: args[0] },          
		...
		const msg = await message.channel.send(`<a:loadin5g:776063953485955072> Setting speed to **${args[0]}x**. This may take a few seconds...`);
		const embed = new Discord.MessageEmbed()
